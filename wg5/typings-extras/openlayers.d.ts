declare namespace ol {
    ...
    interface OverlayOptions {
         ...
         */
        autoPanAnimation?: ol.animation.PanOptions;
    ...
    type ProjectionLike = proj.Projection | string;
    ...
    namespace control {
        ...
        interface DefaultsOptions {
             ...
             * Attribution options.
             */
                //TODO: Replace with ol.control.AttributionOptions
             ...
             * Rotate options
             */
                //TODO: Replace with ol.control.RotateOptions
            rotateOptions?: any;
             ...
             *
             */
                //TODO: Replace with ol.control.ZoomOptions
            zoomOptions?: any;
        }
    }
    ...
    namespace transform {
        function compose(transform: ol.Transform, dx1: number, dy1: number, sx: number, sy: number, angle: number, dx2: number, dy2: number): ol.Transform;

        function create(): ol.Transform;
    }
    ...
    class Attribution {
         ...
         */
        constructor(options: ol.AttributionOptions);
    ...
    class DeviceOrientation extends ol.Object {
         ...
         */
        constructor(options?: ol.DeviceOrientationOptions);
    ...
    class FeatureOverlay {
         ...
         * @param options Options.
         */
        constructor(options?: ol.FeatureOverlayOptions);
    ...
    class Geolocation extends ol.Object {
         ...
         * @param options Options.
         */
        constructor(options?: ol.GeolocationOptions);
    ...
    class Graticule {
         ...
         * @param options Options.
         */
        constructor(options?: ol.GraticuleOptions);
    ...
    class ImageBase extends ol.events.EventTarget {
        ...
        getState(): ol.Image.State;

        getImage(): HTMLCanvasElement|Image|HTMLVideoElement;
    }

    class ImageCanvas extends ol.ImageBase {
        constructor(extent: ol.Extent, resolution: number, pixelRatio: number, attributions: ol.Attribution[], canvas: HTMLCanvasElement, loader?: ol.ImageCanvasLoader);
    }

    interface ImageCanvasLoader {
    ...
    class Image extends ol.ImageBase {
         ...
         * @returns Image.
         */
        getImage(context?: Object): HTMLCanvasElement|Image|HTMLVideoElement;
    ...
    class Map extends ol.Object {
         ...
         */
        constructor(options: ol.MapOptions);
    ...
    class Object extends Observable {
         ...
         * @param Values.
         */
        setProperties(values: any, opt_silent?: boolean): void;
        ...
        on(type: string|string[], listener: Function, theThis?: any);

        once(type: string|string[], listener: Function, theThis?: any);

        un(type: string|string[], listener: Function, theThis?: any);
    ...
    class Overlay extends ol.Object {
         ...
         */
        constructor(options: ol.OverlayOptions);
    ...
    class View extends ol.Object {
         ...
         * @param options Options.
         */
        constructor(options?: ol.ViewOptions);
         ...
         * @param options Options
         */
        fit(geometry: ol.geom.SimpleGeometry | ol.Extent, size: ol.Size, opt_options?: ol.view.FitGeometryOptions): void;
    ...
    namespace animation {
         ...
         */
        function bounce(options: ol.animation.BounceOptions): ol.PreRenderFunction;

        /**
         * Generate an animated transition while updating the view center.
         * @param options Pan options.
         */
        function pan(options: ol.animation.PanOptions): ol.PreRenderFunction;

        /**
         * Generate an animated transition while updating the view rotation.
         * @param options Rotate options.
         */
        function rotate(options: ol.animation.RotateOptions): ol.PreRenderFunction;

        /**
         * Generate an animated transition while updating the view resolution.
         * @param options Zoom options.
         */
        function zoom(options: ol.animation.ZoomOptions): ol.PreRenderFunction;
    }
    ...
    namespace control {
         ...
         * @returns Control.s
         */
        function defaults(options?: ol.control.DefaultsOptions): ol.Collection<ol.control.Control>;
        ...
        class Control extends ol.Object {
            constructor(options: ol.control.ControlOptions);
        ...
        class MousePosition extends Control {
            constructor(options?: ol.control.MousePositionOptions);
        }
        ...
        class Rotate extends Control {
            constructor(opt_options?: ol.RotateOptions);
        }
        ...
        class ZoomToExtent extends Control {
            constructor(options?: ol.ZoomToExtentOptions);
        }
    }
    ...
    namespace events {
        ...
        class EventTarget {
            dispatchEvent<T extends {type: string,target?: EventTarget|ol.events.EventTarget}>(evt: Event|string|T);

            removeEventListener(type: string, listener: ol.EventsListenerFunctionType);

            addEventListener(type: string, listener: ol.EventsListenerFunctionType);
    ...
    namespace format {
        ...
        class GeoJSON extends ol.format.JSONFeature {
             ...
             * @param Options
             */
            constructor(options?: ol.format.GeoJSONOptions);
             ...
             * @returns Feature
             */
            readFeature(source: Document | Node | JSON | string, options?: ol.format.ReadOptions): ol.Feature;
             ...
             * @returns Features
             */
            readFeatures(source: Document | Node | JSON | string, options?: ol.format.ReadOptions): Array<ol.Feature>;
             ...
             * @returns Geometry
             */
            readGeometry(source: Document | Node | JSON | string, options?: ol.format.ReadOptions): ol.geom.Geometry;
             ...
             * @returns GeoJSON
             */
            writeFeature(feature: ol.Feature, options?: ol.format.WriteOptions): string;
             ...
             */
            writeFeatureObject(feature: ol.Feature, options?: ol.format.WriteOptions): JSON;
             ...
             * @returns GeoJSON
             */
            writeFeatures(features: Array<ol.Feature>, options?: ol.format.WriteOptions): string;
             ...
             * @returns GeoJSON object
             */
            writeFeaturesObject(features: Array<ol.Feature>, options?: ol.format.WriteOptions): JSON;
             ...
             * @returns GeoJSON
             */
            writeGeometry(geometry: ol.geom.Geometry, options?: ol.format.WriteOptions): string;
             ...
             * @returns GeoJSON object
             */
            writeGeometryObject(geometry: ol.geom.Geometry, options?: ol.format.WriteOptions): JSON;
        }
        ...
        class WFS {
            readFeatures(source: Document | Node | Object | string, option?: ol.format.ReadOptions): Array<ol.Feature>;
        }

        class WKT {
            constructor(opt_options?: ol.format.WKTOptions);
             ...
             * @returns Feature
             */
            readFeature(source: Document | Node | JSON | string, opt_options?: ol.format.ReadOptions): ol.Feature;
    ...
    namespace interaction {
        ...
        class Draw extends ol.interaction.Pointer {
            constructor(opt_options?: ol.interaction.DrawOptions)
        ...
        class Interaction extends ol.Object {
            constructor(options: {handleEvent: Function});
        ...
        class Modify extends ol.interaction.Pointer {
            constructor(opt_options?: ol.interaction.ModifyOptions)
        }
        ...
        class Select extends ol.interaction.Interaction {
            constructor(opt_options?: ol.interaction.SelectOptions);
        ...
        function defaults(opts: ol.interaction.DefaultsOptions): ol.Collection<ol.interaction.Interaction>;
    ...
    namespace layer {
        ...
        class Base extends ol.Object {
             ...
             */
            constructor(options?: ol.layer.BaseOptions);
        ...
        class Group extends ol.layer.Base {
             ...
             * @param options Layer options.
             */
            constructor(options?: ol.layer.GroupOptions);
        ...
        class Heatmap extends ol.layer.Vector {
             ...
             * @param options Options
             */
            constructor(options?: ol.layer.HeatmapOptions);
        ...
        class Image extends ol.layer.Layer {
             ...
             * @param options Layer options
             */
            constructor(options?: ol.layer.ImageOptions);
        ...
        class Layer extends ol.layer.Base {
             ...
             * @param options Layer options
             */
            constructor(options?: ol.layer.LayerOptions);
        ...
        class Tile extends ol.layer.Layer {
             ...
             */
            constructor(options?: ol.layer.TileOptions);
        ...
        class Vector extends ol.layer.Layer {
             ...
             * @param options Options
             */
            constructor(options?: ol.layer.VectorOptions);
    ...
    namespace proj {
        ...
        function equivalent(projection1: Projection, projection2: Projection);
    }
    ...
    namespace source {
        ...
        class Cluster extends Vector {
            constructor(options: ol.source.ClusterOptions);
        }
        ...
        class Image extends Source {
            ...
            protected getImageInternal(extent: ol.Extent, resolution: number, pixelRatio: number, projection: ol.proj.Projection): ol.ImageBase;
        }
        ...
        class ImageStatic extends ol.source.Image {
            constructor(options?: ol.StaticImageOptions);
        }
        ...
        class ImageWMS extends Image {
            constructor(options: ol.ImageWMSOptions);
        }
        ...
        class OSM extends XYZ {
            constructor(opt_options?: ol.OSMOptions);
        }
        ...
        class Source extends ol.Object {
            ...
            forEachFeatureAtCoordinate<T>(coordinate: ol.Coordinate, resolution: number, rotation: number, skippedFeatureUids: {[key: string]: boolean}, callback: (f: ol.Feature|ol.render.Feature)=>T): T;
        }
        ...
        class TileWMS extends TileImage {
            constructor(options: ol.TileWMSOptions);
             ...
             */
            getGetFeatureInfoUrl(coordinate: ol.Coordinate, resolution: number, projection: ol.ProjectionLike, params: {}): string;
        }
        ...
        class Vector extends Source {
            constructor(opts?: ol.source.VectorOptions)
            ...
            /**
             *
             * @param callback source 以每一个 feature 调用 ,返回 真值停止迭代
             * @param opt_this The object to use as this in the callback
             */
            forEachFeature(callback, opt_this?):any;
        ...
        class WMTS extends TileImage {
            constructor(options: ol.source.WMTSOptions);
        }
    ...
    namespace style {
        ...
        class Circle extends Image {
            constructor(opt_options?: ol.style.CircleOptions);
        }
        ...
        class Fill {
            ...
            constructor(opt_options?: ol.style.FillOptions);
        ...
        class Icon extends Image {
            constructor(option: ol.style.IconOptions)
        }
        ...
        class Stroke {
            constructor(opts?: ol.style.StrokeOptions);
         ...
         */
        class Style {
            constructor(opts: ol.style.StyleOptions);
         ...
         */
        class Text {
            constructor(opt?: ol.style.TextOptions);
    ...
    namespace tilegrid {
        ...
        class TileGrid {
             ...
             */
            constructor(options: ol.tilegrid.TileGridOptions);
        ...
        class WMTS extends TileGrid {
             ...
             */
            constructor(options: ol.tilegrid.WMTSOptions);
        ...
        class Zoomify extends TileGrid {
             ...
             * @param options Options
             */
            constructor(options?: ol.tilegrid.ZoomifyOptions);
        }
         ...
         */
        function createXYZ(options?: ol.tilegrid.XYZOptions): ol.tilegrid.TileGrid;
    }
    ...
    /**
     * Function to perform manipulations before rendering. This function is called with the ol.Map as first and an optional ol.FrameState as second argument. Return true to keep this function for the next frame, false to remove it.
     */
    interface PreRenderFunction { (map: ol.Map, frameState?: ol.FrameState): boolean
    }
    ...
    interface EventsListenerFunctionType {
        (evt: ol.events.Event): void|boolean;
    }
}
