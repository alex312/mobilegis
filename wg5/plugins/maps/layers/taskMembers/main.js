...
define(["require", "exports", "openlayers", "fecha", "../../../../seecool/plugins/Plugins", "../../../../seecool/StaticLib", '../../../../seecool/utils/MapTool', "../../../../seecool/datas/ShipTrackLoader", "./layers/ShipsLayer", "./data/ShipData", './data/ShipDataSource', './data/ScunionShipEntity', './data/RtdsShipSyncer', "../../../../seecool/datas/ShiphistoryApi"], function (require, exports, ol, fecha, Plugins_1, StaticLib_1, MapTool_1, ShipTrackLoader_1, ShipsLayer_1, ShipData_1, ShipDataSource_1, ScunionShipEntity_1, RtdsShipSyncer_1, ShiphistoryApi_1) {
    "use strict";
    ...
    var ShipLayerPlugin = function () {
        function ShipLayerPlugin(config, root, map) {
            ...
            // this.dsShipsTile_ = new ShipsTileDataSource({
            ...
            this.layerShips_ = new ShipsLayer_1.default({
                ...
                criticalResolution: MapTool_1.MapTool.ZoomToResolution(5)
            });
        ...
        _createClass(ShipLayerPlugin, [{
            ...
            value: function expose_() {
                ...
                wg5.taskMembers = {};
                wg5.taskMembers.SetFocus = this.setFocus_.bind(this);
                wg5.taskMembers.LoadTrack = function (start, end) {
            ...
            key: "setFocusByData",
            value: function setFocusByData(data) {
                if (!data.UserId) return;
                var fid = "taskMembers:" + data.UserId;
                ...
                var key = data.UserName; //fid.replace("taskMembers:MMSI:", "");
                        ...
                        case 'apiok':
                            ...
                            try {
                                for (var _iterator = pdata.data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                    ...
                                    if (I.target.Name.toString() == key.toString()) {
            ...
            value: function setFocus_(id) {
                ...
                var key = fid.replace("taskMembers:MMSI:", "");
                return this.searchHistoryApi_(key).then(function (pdata) {
                    var shipSelected = false;
                    switch (pdata.state) {
                        case 'apiok':
            ...
            value: function selectedFeatureChanged_(evt, feature) {
                ...
                if (!(typeof feature.id == "string" && feature.id.startsWith('taskMembers:'))) return null;
            ...
            value: function searchHistoryApi_(key) {
                ...
                //         "Id": 0,
                //         "ShipId": "ID:1038",
                //         "Time": "2016-10-27T10:45:44+08:00",
                //         "Lat": 39.998802185058594,
                //         "Lon": 116.34531402587891,
                //         "Sog": 0.0,
                //         "Cog": 73.8499984741211,
                //         "MMSI": 0,
                //         "Name": "whoperator", //"zfzdoperator1",
                //         "Type": null,
                //         "ShipType": "0",
                //         "Heading": 73.0,
                //         "V_Name": ""
                ...
                return this.searchHistoryApi_(key).then(function (pdata) {
                    switch (pdata.state) {
                        case 'apiok':
                            ...
                            try {
                                for (var _iterator3 = pdata.data[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                    var I = _step3.value;

                                    if (I.Name.toString() == key.toString()) {
                                        this.searchSelectCallback_({ target: I });
                                        break;
                                    }
                                }
                            } catch (err) {
            ...
            value: function searchSelectCallback_(data) {
                ...
                if (shipFeature) this.map_.setFocus(shipFeature);else alert("无法定位!");
                //}.bind(this),500);
            }
            ...
            value: function boxSelect_(list, extent) {
                var ships = list.filter(function (f) {
                    return typeof f.id == "string" && f.id.startsWith('taskMembers:');
                });
