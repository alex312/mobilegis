...
define(["require", "exports", "../../../../../seecool/utilities", "../../../../../seecool/utilities"], function (require, exports, utilities_1, utilities_2) {
    ...
    var ShipsLayerLabelArranger = function ShipsLayerLabelArranger(nearest, farthest, step) {
        _classCallCheck(this, ShipsLayerLabelArranger);
        ...
        this.isOverlap_ = function (box) {
            ...
            for (var i = 0; i < boxes.length; i++) {
                if (this.isRectsOverlap_(boxes[i], box)) return true;
            }
            return false;
        };
        this.isRectsOverlap_ = function (box1, box2) {
            ...
            return box1.x < right2 && right1 > box2.x && box1.y < bottom2 && bottom1 > box2.y;
        };
