...
define(["require", "exports", "../../../../../seecool/utilities", "./ShipShape"], function (require, exports, utilities_1, ShipShape_1) {
    "use strict";

    var ShipsLayerShapeAis = function ShipsLayerShapeAis(option) {
        _classCallCheck(this, ShipsLayerShapeAis);
        ...
        this.box = function () {
            if (!this._box) {
                ...
                this._box = utilities_1.rect.create(l, t, r - l, b - t);
            }
            return this._box;
        };
        this.contains = function (x, y) {
            var tri = this.triangle;
            var alpha = ((tri.p2y - tri.p3y) * (x - tri.p3x) + (tri.p3x - tri.p2x) * (y - tri.p3y)) / ((tri.p2y - tri.p3y) * (tri.p1x - tri.p3x) + (tri.p3x - tri.p2x) * (tri.p1y - tri.p3y));
            var beta = ((tri.p3y - tri.p1y) * (x - tri.p3x) + (tri.p1x - tri.p3x) * (y - tri.p3y)) / ((tri.p2y - tri.p3y) * (tri.p1x - tri.p3x) + (tri.p3x - tri.p2x) * (tri.p1y - tri.p3y));
        ...
        this.createTriangle = function (sog, sinHeading, cosHeading) {
            var width, height;
            if (sog > 0) {
        ...
        this.createTruescaled = function (x, y, width, length, sinHeading, cosHeading) {
            if (!width || !length || width < this.SIZES.AIS_WIDTH || length < this.SIZES.AIS_HEIGHT) return;
            var hh = length / 2;
            var hw = width / 2;
            var qw = width / 4;
        ...
        this.createHeading = function (radHeading, sinHeading, cosHeading, rot, length) {
            ...
            if (this.truescaled) {
                ...
                if (distSqr < bowDistSqr) headLineLength += bowDist - Math.sqrt(distSqr);
            }
        ...
        this.isDangerous = function (ais_cbzl) {
            var a = ais_cbzl % 10;
            var b = (ais_cbzl - a) / 10;
            if (b === 8) return true;
            if ((a === 1 || a === 2 || a === 3 || a === 4) && (b === 2 || b === 4 || b === 6 || b === 7 || b === 9)) return true;
            return false;
        };
        this.SIZES = {
    ...
    ShipShape_1.default.addImplementation(ShipsLayerShapeAis);
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = ShipsLayerShapeAis;
});