...
define(["require", "exports", "text!plugins/maps/layers/shipTeam/uis/ShipTeamInfoSetDiv.html", "knockout"], function (require, exports, ShipTeamInfoSetDiv, ko) {
    "use strict";

    var ShipTeamInfoSet = function () {
        function ShipTeamInfoSet(option) {
            _classCallCheck(this, ShipTeamInfoSet);

            this.dataModel = {
                name: option.name || ""
            };
            this.ui = $(ShipTeamInfoSetDiv);
            this.viewModel = {
                name: ko.observable()
            };
        ...
        return ShipTeamInfoSet;
    }();

    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = ShipTeamInfoSet;
});