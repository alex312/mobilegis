...
import VectorLayer from "seecool/datas/VectorLayer";

class VectorLayerEntity {
    ...
    init() {
        ...
        this.DataSet = new CollectionA<IDCFeature>("plotFeatureSet");
...
export default VectorLayerEntity