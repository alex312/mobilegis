...
define(["require", "exports", "text!./SidePanel.html", "../../ui/uiFrame/WindowView"], function (require, exports, sidePanlDiv, WindowView_1) {
    "use strict";
    ...
    var SidePanel = function (_WindowView_1$default) {
        ...
        function SidePanel(options) {
            ...
            _this.title("在港船舶");
            _this.maxTenPortName_ = options.maxTenPortName;
            _this.maxTenPortSum_ = options.maxTenPortSum;
            _this.maxTenPortClick_ = options.maxTenPortClick;
            _this.portShipListData_ = options.portShipListData;
            return _this;
        }
