...
define(["require", "exports", "openlayers", '../../../../seecool/utilities', "../../../../seecool/datas/ShipFeature"], function (require, exports, ol, utilities, ShipFeature_1) {
    "use strict";

    var SelectOverlay = function SelectOverlay(gps) {
        ...
        this.setFocus = function (feature) {
        ...
        this.setSelect = function (feature) {
            if (!feature) return;
        ...
        this.setFollow = function (feature) {
        ...
        this.handleFocusChange_ = function () {
            this.map_ && this.map_.render();
        };
        this.handleFollowChange_ = function () {
            this.map_ && this.map_.render();
        };
        this.handleMapPostCompose_ = function (event) {
            var geo = this.gps_.getGeometry();
            if (!this.focus_ && !this.follow_ && !geo && this.select_.length == 0) return;
            ...
            if (this.focus_) {
                ...
                if (this.focus_ instanceof ShipFeature_1.default) {
