...
define(["require", "exports", "jquery", "knockout"], function (require, exports, $, ko) {
    ...
    var WindowView = function () {
        function WindowView(htmlTemplate) {
            _classCallCheck(this, WindowView);

            /* -- template example --
             <div class="sc-window-view">
             <div class="head">
             <div class="title" data-bind="text:title()"></div>
             <a class="close-button" data-bind="click:onCommandClose_"><i class="fa fa-close"></i></a>
             </div>
             <div class="body" style="height: 1500px; overflow: auto;padding: 0.5rem">
             <!-- contents -->
             </div>
             </div>
             */
        ...
        _createClass(WindowView, [{
            ...
            value: function attach(parent) {
                this.parent_ = parent;
                if (this.knockout) ko.applyBindings(this, this.element_[0]);
            }
        }, {
            key: "detach",
            value: function detach(parent) {
                if (this.knockout) ko.cleanNode(this.element_[0]);
                this.parent_ = null;
            }
        }, {
            key: "relayout",
            ...
            value: function doLayout() {
                console.warn("Method doLayout is deprecated. Use relayout instead.");
                this.relayout();
            }
        }, {
            key: "get",
            ...
            value: function doClose_() {
                this.navigationView.close(this);
            }
        }, {
            key: "doLayout_",
