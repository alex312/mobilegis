        ...
        function olColorFormat(colorasArray, option) {
            ...
            switch (option) {
                case '#AARRGGBB':
                    ...
                    return '#' + (a[3] < 16 ? '0' + a[3].toString(16) : a[3].toString(16)) + (a[0] < 16 ? '0' + a[0].toString(16) : a[0].toString(16)) + (a[1] < 16 ? '0' + a[1].toString(16) : a[1].toString(16)) + (a[2] < 16 ? '0' + a[2].toString(16) : a[2].toString(16));
                case '#HH4':
                    a[3] = Math.floor(a[3] * 255);
                    return '#' + (a[0] < 16 ? '0' + a[0].toString(16) : a[0].toString(16)) + (a[1] < 16 ? '0' + a[1].toString(16) : a[1].toString(16)) + (a[2] < 16 ? '0' + a[2].toString(16) : a[2].toString(16)) + (a[3] < 16 ? '0' + a[3].toString(16) : a[3].toString(16));
                case '#HH3':
                    return '#' + (a[0] < 16 ? '0' + a[0].toString(16) : a[0].toString(16)) + (a[1] < 16 ? '0' + a[1].toString(16) : a[1].toString(16)) + (a[2] < 16 ? '0' + a[2].toString(16) : a[2].toString(16));
                case 'rgba':
