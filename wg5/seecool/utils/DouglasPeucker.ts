class DouglasPeucker {
    ...
    static byDistance(originalPoints, threshold1, threshold2) {
    ...
    calcUseDistance(originalPoints, threshold1, threshold2) {
    ...
    douglasOptimizerUseDistance(medium_, start, last, threshold1, threshold2) {
        var pl = {};
        var plCount = 0;
    ...
    distanceToLine(startp, endp, outp) {
        var a, b, c, p, s;
